                ...
                <div className="business-grid">
                    <div className="business-card">
                        ...
                        <div className="business-image">
                            <img src="https://images.unsplash.com/photo-1561070791-2526d30994b5?w=600&q=80" alt="Brand Kit" />
                        </div>
                    </div>
                    <div className="business-card">
                        ...
                        <button className="btn-secondary">Learn more</button>
                        <div className="business-image">
                            <img src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80" alt="Team collaboration" />
                        </div>
                    </div>
                    <div className="business-card">
                        ...
                        <div className="business-image">
                            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=600&q=80" alt="Real-time collaboration" />
                        </div>
                    </div>
                    <div className="business-card">
                        ...
                        <div className="business-image">
                            <img src="https://images.unsplash.com/photo-1506784983877-45594efa4cbe?w=600&q=80" alt="Content planning" />
                        </div>
                    </div>
                </div>
            </div>
